...
from tensorflow.keras.layers import Activation, AveragePooling2D, BatchNormalization, Concatenate, Conv2D, \
                                    Dense, GlobalAveragePooling2D, GlobalMaxPooling2D, Input, MaxPooling2D, \
                                    ZeroPadding2D
...
def DenseNet(blocks,
    ...
    if weights == 'imagenet':
        if include_top:
            ...
            raise Exception("Please make sure include_top is True for weights=='imagenet'.")
